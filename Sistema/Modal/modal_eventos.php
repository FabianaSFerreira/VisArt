...
<div class='modal-dialog'>  
    <div class='modal-content'>   
        ...
        <div class='modal-footer'>
            <form action='../show/show_eventos.php' method='post' style="width: -webkit-fill-available;">
...
<div class="modal fade" id="editar_evento" role="dialog">
    <div class="modal-dialog">  
        <div class="modal-content">
            ...
            <form action='../perfil/perfil_eventos.php' method='post' enctype="multipart/form-data" style="width: -webkit-fill-available;">
...
<div class="modal fade" id="excluir_evento" role="dialog">
    <div class="modal-dialog">  
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action='../perfil/perfil_eventos.php' method='post'>
