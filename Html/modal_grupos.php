                    ...
                    if ($DadosGrupo['administrador'] == $usuario) {
                        ...
                        while($us = mysqli_fetch_array($UsGrupos)) {
                            ...
                            if ($us['IdUsuario'] == $DadosGrupo['administrador']) {
                                ...
                                echo "<form action='perfil_grupos.php' method='post'>                                 
        ...
        <div class='modal-footer' style="justify-content: center;">
            <div class='form-group align-center'> 
                <?php
                    ...
                    if ($usuario != "") {
                        if ($us == "") {
                            echo "<form action='show_grupos.php' method='post' style='width: -webkit-fill-available;'>";
                            if ($DadosGrupo['administrador'] != $usuario) {
...
<div class="modal fade" id="editar_grupo" role="dialog">
    <div class="modal-dialog">  
        <div class="modal-content">
            ...
            <form action='perfil_grupos.php' method='post' enctype="multipart/form-data">
